...
def make_encoder(data_tesor, code_size):
    x = tf.layers.flatten(data_tesor)
...
def make_decoder(code, data_shape):
    ...
    return tfp.distributions.Independent(tfp.distributions.Bernoulli(logit), 2)
...
if __name__ == '__main__':
    # for multiple uses of these blocks
    ...
    samples = make_decoder(prior.sample(10), [28, 28]).sample()
